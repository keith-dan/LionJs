...
k(p[b],a);for(b=0;b<v.length;b++)m(v[b])&&k(v[b],a)};this.dispose=function(){if(this.isdisposed)console.log("object was disposed");else{for(var a=0;a<this.elements.length;a++)this.elements[a].dispose(),this.elements[a]=null,this.elements=[];this.isdisposed=!0}}}function a(){d.call(this);this.type="lion.BackgroundLayer";this.__data__.backgroundColor="#eeeeee";var a=this,b;this.renderBackground=function(c){b?c.putImageData(b,0,0):(c.fillStyle=a.backgroundColor,c.fillRect(a.x,a.y,a.width,a.height),b=
c.getImageData(0,0,a.width,a.height))}}function b(){d.call(this,c.LayerMode.Virtual);this.type="lion.VirtualLayer";var a=this,b=null,e=c.LayerMode.Virtual;this.getVirtualRect=function(){if(b)return b.drawBounds};this.onmousedown=function(d){0==d.button&&c.Util.andEnum(a.scene.mode,c.SceneMode.MultipleSelect)&&(b||(b=new c.RectElement,a.add(b,c.LayerMode.Virtual)),b.x=d.offsetX,b.y=d.offsetY,b.setParent(a),b.backgroundColor="rgba(175,175,175,0.2)",b.width=0,b.height=0,b.borderColor="#333333",b.borderSize=
1)};this.onmousemove=function(a){e==c.LayerMode.Virtual&&b&&(b.width=a.offsetX-b.x,b.height=a.offsetY-b.y)};this.onmouseup=function(c,d){b&&(a.remove(b),b=null);a.clear()}}d.prototype=new c.Element(!0);d.prototype.setParent=function(a){c.Element.prototype.setParent.call(this,a);this.stage=a.stage;this.scene=a;for(a=0;a<this.elements.length;a++)this.elements[a].setParent(this)};d.prototype.findElementById=function(a){for(var b=0;b<this.elements.length;b++)if(this.elements[b].id==a)return this.elements[b]};
d.prototype.onserialize=function(a,b){var c="";if("elements"==a){c+='"'+a+'":[';for(a=0;a<b.length;a++)c+=b[a].serialize()+",";","==c[c.length-1]&&(c=c.substr(0,c.length-1));c+="]"}return c};d.prototype.ondeserialize=function(a,b){if("elements"==a){this._elements_=[];for(a=0;a<b.length;a++)this._elements_.push(b[a]);return!0}};d.prototype.enddeserialize=function(){if(this._elements_)for(var a=0;a<this._elements_.length;a++){var b=c.Element.deserialize(this._elements_[a]);this.add(b);b.enddeserialize()}delete this._elements_};
c.Layer=d;a.prototype=new d(!0);Object.defineProperties(a.prototype,{backgroundColor:{get:function(){return this.getValue("backgroundColor")},set:function(a){this.setValue("backgroundColor",a);this.invalidLayout()},enumerable:!0}});c.BackgroundLayer=a;b.prototype=new d(!0);c.VirtualLayer=b}(l);!function(c){function d(a){var b,d;function f(a){return a==c.LayerMode.Virtual?k.layers.virtual:a==c.LayerMode.Force?k.layers.force:a==c.LayerMode.Background?k.layers.background:k.layers.action}function e(a,
b){b==c.LayerMode.Force?k.layers.force.add(a):b==c.LayerMode.Background?k.layers.background.add(a):b==c.LayerMode.Virtual?k.layers.virtual.add(a):k.layers.action.add(a);if(m&&!(a instanceof c.BirdsEye))a.onLayout(m.invalidLayout,m)}c.Element.call(this);this.type="lion.Scene";this.layers={};var q=this.__data__;q.x=0;q.y=0;q.mode=c.SceneMode.Normal;var m;this.showBirdsEye=function(){m=new c.BirdsEye;m.canDrag=!1;e(m,c.LayerMode.Force)};var k=this;this.setLayer=function(a,b){if(a==c.LayerMode.Virtual){var d=
b?b:new c.VirtualLayer;k.layers.virtual=d}else a==c.LayerMode.Force?(d=b?b:new c.Layer(a),k.layers.force=d):a==c.LayerMode.Action?(d=b?b:new c.Layer(a),k.layers.action=d):a==c.LayerMode.Background&&(d=b?b:new c.BackgroundLayer,k.layers.background=d);d.setValue("id",E());d.setParent(k)};this.setScale=function(a,b){b?b==c.LayerMode.Action?k.layers.action.setScale(a):b==c.LayerMode.Background&&k.layers.background.setScale(a):(k.layers.action.setScale(a),k.layers.background.setScale(a))};this.addElement=
...
f=null;if(g)f=k.layers.force;else if(g=k.layers.action.onmousedown(a))f=k.layers.action;else k.layers.virtual.onmousedown(a);for(var e=0;e<k.events.mousedown.length;e++)k.events.mousedown[e](a,k,g,f?f.mode:null)};var h=b=!1;var l=d=0;this.__onmousemove=function(a){if(k.mode==c.SceneMode.Move&&(b&&3<Math.abs(d-a.offsetX)&&3<Math.abs(l-a.offsetY)&&(h=!0),h)){k.x+=a.clientX-d;k.y+=a.clientY-l;d=a.clientX;l=a.clientY;k.layers.action.refresh();k.layers.background.refresh();return}k.layers.force.onmousemove(a);
k.layers.virtual.onmousemove(a);k.layers.action.onmousemove(a);if(p||u){var g=k.layers.force.getHoverElement();g||(g=k.layers.action.getHoverElement());for(var f=0;f<k.events.mousemove.length;f++)k.events.mousemove[f](a,g)}};this.__onmouseup=function(a){var c=k.layers.virtual.getVirtualRect();k.layers.virtual.onmouseup(a);k.layers.force.onmouseup(a);var d=k.layers.action.onmouseup(a,c);if(n||u){var g=k.layers.force.getActionElement();g||(g=k.layers.action.getActionElement());for(c=0;c<k.events.mouseup.length;c++)k.events.mouseup[c](a,
...
a.closePath();a.fill()}};d.prototype.renderTooltip=function(a){this.tooltip.visible&&this.tooltip.render(a)};d.prototype.renderLine=function(a,b,c,d){if(d==l.LineStyle.Dotted){d=Math.floor(Math.sqrt(Math.pow(c.x-b.x,2)+Math.pow(c.y-b.y,2))/5);for(var g=0;g<d;g++)a[0==g%2?"moveTo":"lineTo"](b.x+(c.x-b.x)/d*g,b.y+(c.y-b.y)/d*g);a.stroke()}};d.prototype.setAnimation=function(a){a.setElement(this);a.animationId=parseInt(1E5*Math.random());x[a.animationId]=a;this.animations.push(a);return a.animationId};
...
function(a,b){function d(a,b,d,g){var h=b.measureText(d[g]).width;b=b.measureText("\u7530").width;a.lineHeight=b;var k=new z;if(null!=a.drawBounds){f=h;e=b;a.allowMultiline&&(f<h&&(f=h),e=d.length*b);if(0==a.drawBounds.width&&0==a.drawBounds.height){var q=a.drawBounds.x+3;a=a.drawBounds.y+g*b+b+3}else a.align==c.Align.Center?(q=a.drawBounds.x+(a.drawBounds.width-f)/2,a=a.drawBounds.y+(a.drawBounds.height-e)/2+g*b+b-5):a.align==c.Align.TopLeft?(q=a.drawBounds.x,a=a.drawBounds.y-(d.length-1-g)*b-5):
a.align==c.Align.TopMiddle?(q=a.drawBounds.x+(a.drawBounds.width-f)/2,a=a.drawBounds.y-(d.length-1-g)*b-5):a.align==c.Align.TopRight?(q=a.drawBounds.x+(a.drawBounds.width-f),a=a.drawBounds.y-(d.length-1-g)*b-5):a.align==c.Align.MiddleLeft?(q=a.drawBounds.x+2,a=a.drawBounds.y+(a.drawBounds.height-e)/2+g*b+b-5):a.align==c.Align.MiddleRight?(q=a.drawBounds.x+(a.drawBounds.width-f)-2,a=a.drawBounds.y+(a.drawBounds.height-e)/2+g*b+b-5):a.align==c.Align.BottomLeft?(q=a.drawBounds.x,a=a.drawBounds.y+a.drawBounds.height+
(g+1)*b):a.align==c.Align.BottomMiddle?(q=a.drawBounds.x+(a.drawBounds.width-f)/2,a=a.drawBounds.y+a.drawBounds.height+(g+1)*b):a.align==c.Align.BottomRight?(q=a.drawBounds.x+(a.drawBounds.width-f)-2,a=a.drawBounds.y+a.drawBounds.height+(g+1)*b):(q=a.drawBounds.x,a=a.drawBounds.y);k.x=q;k.y=a}else k.x=a.x,k.y=a.y-b;k.width=h;k.height=b;return k}var f=0,e=0;if(this.allowMultiline){for(var q=[],m=0;m<b.length;m++){var k=d(this,a,b,m);q.push(k);this.pointLines.push({x:k.x,y:k.y})}return n(q)}return d(this,
a,b,0)};d.prototype.updateBounds=function(a){this.isGraphicText&&this.stage.notifyCmd("updateGraphicText",{font:this.fontFamliy,id:this.id,text:this.text,size:this.fontSize});c.GeoElement.prototype.updateBounds.call(this,a)};d.prototype.measureText=function(a){if(!c.Util.isNullOrWhitespace(this.drawText)){this.pointLines.splice(0);a.font=parseInt(this.fontSize*this.scale)+"px "+this.fontFamliy;var b=this.textlines;b.splice(0);this.allowMultiline?G(b,this.drawText.split("\r\n")):G(b,[this.drawText]);
this.textRect=this.measureLines(a,this.textlines)}return this.textRect};d.prototype.renderText=function(a,b,d,f){b=void 0!=b?b:this.drawText;d=void 0!=d?d:this.drawBounds;f=void 0!=f?f:this.foreColor;a.shadowBlur=0;if(!c.Util.isNullOrWhitespace(b))if(a.font=parseInt(this.fontSize*this.scale)+"px "+this.fontFamliy,a.fillStyle=f,this.allowMultiline)for(f=0;f<this.textlines.length;f++)a.fillText(this.textlines[f],this.pointLines[f].x,this.pointLines[f].y);else try{a.fillText(b,d.x,d.y)}catch(e){console.log(e)}};
...
this.invalidLayout()))};d.prototype.buildNodes=function(){if(this.shownodes&&(this.initNodes(),0==this.displayNodes.length))if(1==this.shownodes)G(this.displayNodes,this.nodes);else{this.displayNodes=[];for(var a=0;a<this.shownodes.length;a++)this.displayNodes.push(this.getNode(this.shownodes[a]))}};d.prototype.showNodes=function(a){this.shownodes=a?a:1;this.invalidLayout()};d.prototype.getNode=function(a){0==this.nodes.length&&this.initNodes();for(var b=0;b<this.nodes.length;b++)if(this.nodes[b].controlMode==
...
if(!a||a&&-1<a.indexOf(c.EndPointMode.Center))b=new c.EndPoint(this),b.scale=this.scale,b.controlMode=c.EndPointMode.Center,b.x=this.width/2-4,b.y=this.height/2-4,this.nodes.push(b);for(a=0;a<this.nodes.length;a++)this.nodes[a].setValue("id",E(this.nodes)),this.nodes[a].setParent(this)}};d.prototype.dispose=function(){if(!this.isdisposed){for(var a=0;a<this.nodes.length;a++)this.nodes[a].dispose(),this.nodes[a]=null;this.nodes.splice(0);c.BaseTextElement.prototype.dispose.call(this);this.isdisposed=
...
a.fill());a.restore()};d.prototype.preRender=function(a){};d.prototype.setEditMode=function(a){this.canEdit&&this.canEvent&&(this.setValue("editMode",a),this.editMode>c.EditMode.Select&&this.invalidLayout())};c.PolygonElement=d}(l);!function(c){function d(){c.NodeElement.call(this);this.type="lion.BirdsEye";var a=this;this.height=this.width=100;this.position=c.Position.BottomRight;var b=new z;Object.defineProperties(this,{rect:{get:function(){return b},enumerable:!1}});var d=[];Object.defineProperties(this,
...
this.drawBounds.width=this.width;this.drawBounds.height=this.height;this.rectChildren.splice(0);a=this.width/this.scene.width;for(var b=this.height/this.scene.height,d=this.scene.layers.action.elements,f=0;f<d.length;f++)d[f]instanceof c.LinkElement||d[f]instanceof c.LineElement||this.rectChildren.push(new z(this.drawBounds.x+d[f].x*a,this.drawBounds.y+d[f].y*b,d[f].width*a,d[f].height*b))};d.prototype.render=function(a){a.fillStyle=this.backgroundColor;a.fillRect(this.drawBounds.x,this.drawBounds.y,
